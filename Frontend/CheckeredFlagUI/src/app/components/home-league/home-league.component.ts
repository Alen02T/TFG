...
export class HomeLeagueComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._grandPrixService.getGrandPrixById(this.getLastRace()).subscribe(apiEscuderia => this.grandPrix=apiEscuderia);
    ...
    this._grandPrixService.getGrandPrixById(this.getLastRace()).subscribe(apiStandings=>{
