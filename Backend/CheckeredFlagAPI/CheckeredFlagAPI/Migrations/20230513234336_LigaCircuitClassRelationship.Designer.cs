...
namespace CheckeredFlagAPI.Migrations
{
    ...
    [Migration("20230513234336_LigaCircuitClassRelationship")]
    partial class LigaCircuitClassRelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CheckeredFlagAPI.Models.Liga", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CircuitLiga", b =>
                {
                    ...
                    b.HasKey("CircuitscircuitId", "LigasId");

                    b.HasIndex("LigasId");

                    b.ToTable("CircuitLiga");
                });
            ...
            modelBuilder.Entity("CircuitLiga", b =>
                {
                    b.HasOne("CheckeredFlagAPI.Models.Circuit", null)
                        .WithMany()
                        .HasForeignKey("CircuitscircuitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CheckeredFlagAPI.Models.Liga", null)
                        .WithMany()
